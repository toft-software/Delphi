...
destructor TCustomerListe.Destroy;
begin
...
function TCustomerListe.Load(manufacturerid: integer; customergroupid : integer): TFunktionsResultat;
var
  t : TCustomerListe;
  svc : string;
  RESTRequest1 : TRESTRequest;
...
begin
  ...
  try
    ...
    svc := 'GetCustomerListFromManufacturerIDCustomerGroupID';
    RestResponse1DataSetAdapter.Dataset :=  self.pClientDataSet;
    RestResponse1DataSetAdapter.RootElement := svc+'Result.customerliste';
    RESTRequest1.Resource := svc+'/'+IntToStr(manufacturerid)+'/'+IntToStr(customergroupid);
    RESTRequest1.Execute;
...
//     Begin
//        result.Status:=rsFejl;
//        result.Besked:='Den valgte chauffør kunne ikke findes!';
//     End;
//   except
//     on e:exception do
//     Begin
