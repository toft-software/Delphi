...
var
  ...
  tmpFunkResult : TFunktionsResultat;
begin
  if  (formSystemBesked.SystemSpoergsmaal('Ønsker du at slette '+ self.pCustomerGroupAll.ClientDataSetCustomerGroupNameID.FieldByName('Name').AsString)) then
  begin
    tmpCustomerGroup := TCustomerGroup.Create;
    ...
    begin
      tmpFunkResult.Free;
      tmpCustomerGroup.Free;
      self.pCustomerGroupAll.ClientDataSetCustomerGroupNameID.Delete;
    end;
  end;
end;
