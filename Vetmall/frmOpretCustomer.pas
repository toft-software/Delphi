...
begin
  if  (formSystemBesked.SystemSpoergsmaal('Ønsker du at oprette '+ self.pCustomerList.ClientDataSet.FieldByName('praksisnavn').AsString)) then
  begin
    ...
    begin
      ...
      if tmpFunkResult.Status = rsOk then
      begin
        formSystemBesked.SystemBesked(self.pCustomerList.ClientDataSet.FieldByName('praksisnavn').AsString + ' er oprettet OK !');
        tmpFunkResult.Free;
        tmpCustomer.Free;
        ClearCtrl;
      end;
